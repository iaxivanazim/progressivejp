<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="form-group mt-4">
            ...
            <x-text-input id="status" class="form-control mt-1" type="text" name="status" :value="old('status')" required autocomplete="status" />
        ...
        <div class="form-group mt-4">
            ...
            <x-text-input id="pin" class="form-control mt-1" type="text" name="pin" :value="old('pin')" required autocomplete="pin" />
